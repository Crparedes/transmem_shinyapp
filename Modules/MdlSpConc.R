spConcModuleUI <- function(id, Spc = 'Main') {
  ns <- NS(id)
  box(title = paste0(Spc, ' species'), width = 12, status = Hcol(id = Spc)[1], solidHeader = TRUE,
      ...
      tags$hr(),
      box(title = 'Single phase profiles: Strip', width = 3, status = Hcol(id = Spc)[1],
          downloadButton(ns('DwnSP.Str'), label = 'Download plot'), plotOutput(ns("SP.Str"))),
      box(title = 'Single phase profiles: Feed', width = 3, status = Hcol(id = Spc)[1],
          downloadButton(ns('DwnSP.Fd'), label = 'Download plot'), plotOutput(ns("SP.Fd"))),
      box(title = 'Final value per cycle: Strip', width = 3, status = Hcol(id = Spc)[1],
          downloadButton(ns('DwnFV.Str'), label = 'Download plot'), plotOutput(ns("FV.Str"))),
      box(title = 'Final value per cycle: Feed', width = 3, status = Hcol(id = Spc)[1],
